...
export class TransactionResolverBase {
  ...
  async createTransaction(
    ...
    return await this.service.createTransaction({
      ...
      data: {
        ...
        paymentMessage: args.data.paymentMessage
          ? {
              connect: args.data.paymentMessage,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => PaymentMessage, {
    nullable: true,
    name: "paymentMessage",
  })
  async getPaymentMessage(
    ...
    const result = await this.service.getPaymentMessage(parent.id);
